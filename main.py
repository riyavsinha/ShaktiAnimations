...
class IntroScene(Scene):
    def construct(self):
        ...
        web = decentralized_web().shift(UP*2 + RIGHT*4)
        ...
        self.play(FadeIn(ada), ShowCreation(iohk_to_ada), flower.eyes.animate.look_at(ada))
        self.wait(4)
        p1 = Tex(r"A Proposal for An Ethereum Classic\\Treasury System").move_to(UP*1+LEFT*3)
        p2 = Tex(r"Ouroboros: A Provably Secure\\Proof-of-Stake Blockchain Protocol").move_to(DOWN*1.5+LEFT*2.5)
        p3 = Tex(r"Impossibility on Tamper-Resilient\\Cryptography with Uniqueness Properties").move_to(DOWN*3+LEFT*1)
        p4 = Tex(r"SoK: A Taxonomy for Layer-2 Scalability\\Related Protocols for Cryptocurrencies").move_to(UP*2.5+RIGHT*2)
        p5 = Tex(r"Upper Bound Probability of Double\\Spend Attack on SPECTRE").move_to(DOWN*.5+RIGHT*3)
        self.play(FadeIn(p1), flower.eyes.animate.look_at(p1))
        self.wait(1)
        self.play(FadeIn(p2), flower.mouth.animate.o_mouth(), flower.eyes.animate.look_at(p2))
        self.wait(1)
        self.play(FadeIn(p3), flower.eyes.animate.look_at(p3))
        self.wait(1)
        self.play(FadeIn(p4), flower.eyes.animate.look_at(p4))
        self.wait(1)
        self.play(FadeIn(p5), flower.eyes.animate.look_at(p5))
        self.wait(1)
        ...
        self.play(flower.mouth.animate.smile(), flower.eyes.animate.look_at(p1))
        self.wait(1)
        ...
        self.wait(2)
        self.play(Write(video_2), Blink(flower))
        self.wait(2)
        self.clear()
...
class EthIntroScene(Scene):
    def construct(self):
        ...
        self.play(comm_group.animate.shift(UP))
